export const commonAnswers = {
  ...
  "notebook": [],
  'watermelon': [  "water",  "lemon",  "melon",  "metal",  "relate",  "later",  "rental",  "tale",  "team",  "tone",  "note",  "rate",  "earn",  "mean",  "wane",  "wear",  "mere",  "meal",  "name",  "lawn",  "mate",  "near",  "mole",  "now",  "own",  "ear",  "era",  "raw",  "law",  "tear",  "lean",  "loan",  "lone",  "noel",  "tome",  "roam",  "more",  "mow",  "new",  "men",  "man",  "tame",  "team",  "art",  "are",  "real",  "term",  "tern",  "toe",  "lane",  "warm",  "worm",  "oar",  "owl",  "nowhere"],  
  "knowledge" : [
      "den",
      "doe",
      "dog",
...
//get keys of commonAnswers 
export const gamewords = Object.keys(commonAnswers);
